...
var resultController = function($scope, $log, $http, $location){
    ...
    var getPaginationComplete = function(response){
        ...
        $scope.pressureList = response.data.list;
    ...
    $scope.pagination = function(next, startOver){
        ...
        $http({
            url: '/pressuretableapi/?count='+$scope.initial.curShowPerPage+'&page='+page+'&year='+$scope.initial.default_year+'&district='+$scope.initial.default_district,
            method: 'GET',
    ...
    $scope.getTemplate = function (pressure_O) {
